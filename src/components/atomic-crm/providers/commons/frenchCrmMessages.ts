  ...
  resources: {
    ...
    employees: {
      ...
      fields: {
        ...
        sales_id: "Compte CRM",
        designation_helper: "Choisissez un département pour affiner cette liste",
        ...
        bank_ifsc: "Code IFSC / guichet",
        previous_employer: "Employeur précédent",
        previous_designation: "Poste précédent",
      ...
      sections: {
        ...
        past_employment: "Expérience précédente",
    ...
    assignments: {
      ...
      fields: {
        ...
        due_date: "Échéance",
        time_block: "Créneau",
        blocked_on: "En attente de",
        blocked_on_helper: "Sur quoi ou qui cette tâche est-elle bloquée, le cas échéant ?",
      ...
      time_block: {
        fajr_quran: "Fajr / Coran",
        morning_prep: "Préparation matinale",
        deep_work_1: "Travail de fond n°1",
        sales_comm: "Ventes / communication",
        buffer: "Tampon / travail léger",
        deep_work_2: "Travail de fond n°2",
        learning: "Apprentissage",
        exercise: "Sport",
        evening_personal: "Soirée / personnel",
        evening_review: "Bilan du soir",
      },
      action: {
  ...
  crm: {
    ...
    weekly_planner: {
      ...
      focus: {
        ...
        placeholder: "Objectifs, contraintes, priorités pour cette semaine…",
        saved: "Enregistré",
      },
      review: {
        title: "Bilan du soir",
        completed: "Qu'ai-je vraiment terminé ?",
        blocked: "Qu'est-ce qui a été bloqué ?",
        changed: "Qu'est-ce qui a changé ?",
        avoid_tomorrow: "Une chose à NE PAS faire demain",
        top3_tomorrow: "Top 3 de demain",
        top3_placeholder: "Objectif majeur %{index}",
        if_time_allows: "Si le temps le permet (un par ligne)",
        history: "Historique récent",
        saved: "Bilan enregistré",
      },
    },
    photo_galleries: {
      nav_label: "Galeries photos",
      title: "Galeries photos",
      photographers: "Photographes",
      new_photographer: "Nouveau photographe",
      photographer_name: "Nom du photographe",
      no_photographers: "Aucun photographe pour le moment",
      back_to_photographer: "Retour au photographe",
      new: "Nouvelle galerie",
      name: "Nom de la galerie",
      client_name: "Nom du client",
      create: "Créer la galerie",
      empty: "Aucune galerie pour le moment",
      share_link: "Lien de partage",
      share_link_hint: "Toute personne ayant ce lien peut voir ces photos -- aucune connexion requise.",
      photos: "Photos",
      upload: "Ajouter des photos",
      uploading: "Envoi en cours...",
      upload_error: "Échec de l'envoi de %{filename}",
      folder_error: "Échec de la préparation du dossier de la galerie",
      no_photos: "Aucune photo pour le moment",
      queue_progress: "Envoi de %{filename} (%{current} sur %{total})",
      queue_error: "Échec : %{filename}",
      queue_retry: "Réessayer",
      queue_retry_limit: "Limite de tentatives atteinte",
      new_album: "Nouvel album",
      album_name: "ex. Extérieur, Intérieur",
      no_albums: "Aucun album pour le moment",
      back_to_gallery: "Retour à la galerie",
      give_login: "Donner à ce photographe son propre accès",
      login_email: "Email de connexion",
      login_password: "Mot de passe temporaire",
      login_error: "Échec de la création de l'accès",
      storage_used: "%{size} utilisés sur %{count} photos",
    ...
    accounts: {
      ...
      dashboard: {
        ...
        invalid_budget_amount: "Saisissez un montant supérieur à 0.",
