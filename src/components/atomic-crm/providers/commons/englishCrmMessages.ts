  ...
  resources: {
    ...
    employees: {
      ...
      fields: {
        ...
        sales_id: "CRM login",
        designation_helper: "Pick a department to narrow this list",
    ...
    assignments: {
      ...
      fields: {
        ...
        blocked_on: "Waiting on",
        blocked_on_helper: "What or who is this stuck on, if anything?",
      ...
      time_block: {
        fajr_quran: "Fajr / Quran",
        morning_prep: "Morning prep",
        deep_work_1: "Deep work #1",
        sales_comm: "Sales / communication",
        buffer: "Buffer / light work",
        deep_work_2: "Deep work #2",
        learning: "Learning",
        exercise: "Exercise",
        evening_personal: "Evening / personal",
  ...
  crm: {
    ...
    weekly_planner: {
      ...
      focus: {
        ...
        placeholder: "Goals, constraints, priorities for this week…",
        saved: "Saved",
      },
      review: {
        title: "Nightly review",
        completed: "What did I actually finish?",
        blocked: "What got blocked?",
        changed: "What changed?",
        avoid_tomorrow: "One thing I should NOT do tomorrow",
        top3_tomorrow: "Tomorrow's top 3",
        top3_placeholder: "Major outcome %{index}",
        if_time_allows: "If time allows (one per line)",
        history: "Recent history",
        saved: "Review saved",
      },
    },
    photo_galleries: {
      nav_label: "Photo Galleries",
      title: "Photo Galleries",
      photographers: "Photographers",
      new_photographer: "New photographer",
      photographer_name: "Photographer name",
      no_photographers: "No photographers yet",
      back_to_photographer: "Back to photographer",
      new: "New gallery",
      name: "Gallery name",
      ...
      share_link_hint: "Anyone with this link can view these photos -- no login needed.",
      photos: "Photos",
      upload: "Upload photos",
      uploading: "Uploading...",
      upload_error: "Failed to upload %{filename}",
      folder_error: "Failed to prepare the gallery's folder",
      no_photos: "No photos yet",
      queue_progress: "Uploading %{filename} (%{current} of %{total})",
      queue_error: "Failed: %{filename}",
      queue_retry: "Retry",
      queue_retry_limit: "Retry limit reached",
      new_album: "New album",
      album_name: "e.g. Outdoor, Indoor",
      no_albums: "No albums yet",
      back_to_gallery: "Back to gallery",
      give_login: "Give this photographer their own login",
      login_email: "Login email",
      login_password: "Temporary password",
      login_error: "Failed to create the login",
      storage_used: "%{size} used across %{count} photos",
    ...
    preferences: {
      title: "Preferences",
      subtitle: "Customize your dashboard layout preferences.",
      ...
      sidebar: "Sidebar",
      floating: "Floating",
      sidebar_collapse_mode: "Sidebar Collapse Mode",
      icon: "Icon",
      offcanvas: "OffCanvas",
      note_corners: "Note Corners",
      rounded: "Rounded",
      square: "Square",
