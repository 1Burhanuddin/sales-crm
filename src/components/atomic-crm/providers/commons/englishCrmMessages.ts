export const englishCrmMessages = {
  resources: {
    ...
    leave_requests: {
      name: "Leave Request |||| Leave Requests",
      fields: {
    ...
    transactions: {
      ...
      upload: {
        ...
        wrong_password: "That password didn't work — try again.",
        password_placeholder: "PDF password",
        unlock: "Unlock",
        summary: "%{total} transactions found. %{duplicates} look like duplicates and are unchecked by default.",
        mismatch_note: "%{count} have a balance mismatch — review before importing.",
        possible_duplicate: "Possible duplicate",
        balance_mismatch: "Balance mismatch",
        import_button: "Import %{count} transactions",
        success: "Imported %{count} transactions.",
        partial_failure: "Imported, but %{count} row(s) failed.",
      },
    },
    statement_imports: {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Welcome to Quixsyn CRM",
    },
    common: {
      activity: "Activity",
      added: "added",
    ...
    profile: {
      inbound: {
        description:
          "You can start sending emails to your server's inbound email address, e.g. by adding it to the %{field} field. Quixsyn CRM will process the emails and add notes to the corresponding contacts.",
        title: "Inbound email",
      },
      mcp: {
        title: "MCP Server",
